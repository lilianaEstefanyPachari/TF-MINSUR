	...
	return (
		<section className={style.sectionStyle}>
			...
			<div className={style.nameDsctoStyle}>
				<div>
					<h3 style={{ fontSize: 20, color: '#003DA5' }}>
						Nombre del descuento
					</h3>
					<p style={{ fontSize: 15, color: '#4F758B' }}>
						Categoria del descuento
					</p>
				</div>
				<AiOutlineHeart
			...
			<div>
				...
				>
					Tienes 50% de descuento en toda la carta o consumos para llevar
				</h4>
				<br />
				<p
					style={{
				...
				>
					Euismod tincidunt ut laoreet dolore magna aliquam erat lorem ipsum
				...
				<div className={style.iconsStyle}>
					...
					/>
					<FaCcVisa
						style={{ fontSize: 50, color: '#D9D9D9', padding: 4, marginTop: 5 }}
					/>
					<FaCcVisa
						style={{ fontSize: 50, color: '#D9D9D9', padding: 4, marginTop: 5 }}
					/>
